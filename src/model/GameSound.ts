class GameSound{
    ...
    private audio_url = 'resource/assets/audio/';
    private soundVec;
    playSound(type = 1){
        ...
        let resName = "";
        if(type == 1){
            resName = this.audio_url+"coin.mp3";
        }
        else if(type == 2){
            resName = this.audio_url+"qianjiangli.mp3";
        }
        else if(type == 3){
            resName = this.audio_url+"shengji.mp3";
        }
        else if(type == 4){
            resName = this.audio_url+"tanchufuqi.mp3";
        }
        else if(type == 5){
            resName = this.audio_url + "composite.mp3";
        }
        try{
